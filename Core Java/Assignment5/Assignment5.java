...
public class Assignment5 {
    public static void main(String[] args) {
        ...
        System.out.println(newslist.stream().collect(Collectors.groupingBy((News n)->n.getPostedByUser(),Collectors.counting())));
		...
		transactions.add(new Transaction(new Trader("b", "b"), 2012, 50000));
		...
		transactions.add(new Transaction(new Trader("e", "Pune"), 2015, 75000));
